...
from DataHandler.AccountingGNNDatasetStatic import AccountingGNNDatasetStatic
from ModelHandler import GNNAutoencoderStatic
from VisualisationHandler import VisualisationHandler
from LoggingHandler import LoggingHandler

# class GraphAutoencoderExperiment
class GraphAutoencoderExperimentStatic(object):
    ...
    def run_experiement(self, parameter, data_parameter):
        ...
        prepared_tensor_entries = AccountingGNNDatasetStatic(adj_matrices=adj_matrices, feat_matrices=feat_matrices)
        ...
        # init the static graph autoencoder model
        model = GNNAutoencoderStatic.GNNAutoencoderStatic(
