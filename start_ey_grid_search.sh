...
# set alpha parameter
declare -a betas=(0.5 0.1)

# set architecture parameter
declare -a encoder_dim=(64 32 16 8 4 2)
declare -a decoder_dim=(2 4 8 16 32 64)
declare -a lat_embed_dim=2
declare -a feat_embed_dims=(2 4 8 12)
  ...
  do
    ...
    do
      ...
      do
        ...
        run_dir=${run_id}_bt_${beta}_fe_${feat_embed_dim}
        ...
        exp_postfix=${run_id}_sd_${seed}_beta_${beta}_fe_${feat_embed_dim}
